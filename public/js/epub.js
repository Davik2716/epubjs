			...
			var IframeView = function () {
				...
				_createClass(IframeView, [{
					...
					value: function create() {
						...
						// Revisar esta parte arriba y abajo
					...
					value: function highlight(cfiRange) {
						...
						// color luego de resaltarse
						// var color_final = 'blue'
						var color_final = document.getElementById("resaltador").value
						var m = new _marksPane.Highlight(range, "epubjs-hl",
							// data, { 'fill': 'green', 'fill-opacity': '0.3', 'mix-blend-mode': 'multiply' });
							data, { 'fill': color_final, 'fill-opacity': '0.3', 'mix-blend-mode': 'multiply' });
